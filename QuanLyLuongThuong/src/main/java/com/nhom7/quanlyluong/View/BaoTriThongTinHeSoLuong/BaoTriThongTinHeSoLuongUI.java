...
package com.nhom7.quanlyluong.View.BaoTriThongTinHeSoLuong;

import com.nhom7.quanlyluong.Controller.BaoTriThongTinHeSoLuongController;
...
public class BaoTriThongTinHeSoLuongUI extends javax.swing.JFrame {
    ...
    private void btnThemHeSoLuongActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btnThemHeSoLuongActionPerformed
    ...
    private void btnSuaHeSoLuongActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btnSuaHeSoLuongActionPerformed
        TuyChonUI tuyChonUI = new TuyChonUI();
        tuyChonUI.setOnHandleOptionEvent(new IOptionEvent() {
            @Override
            public void onAcceptEvent() {
    ...
    private void btnXoaHeSoLuongActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btnXoaHeSoLuongActionPerformed
        TuyChonUI tuyChonUI = new TuyChonUI();
        tuyChonUI.setOnHandleOptionEvent(new IOptionEvent() {
            @Override
            public void onAcceptEvent() {
    ...
    private void btnXoaThongTinActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btnXoaThongTinActionPerformed
        TuyChonUI tuyChonUI = new TuyChonUI();
        tuyChonUI.setOnHandleOptionEvent(new IOptionEvent() {
            @Override
            public void onAcceptEvent() {
